(ns algorithm-clj.function-composition)


;; Question: Function composition is a mathematical operation that mainly presents itself in
;; lambda calculus and computability. It is explained well here,
